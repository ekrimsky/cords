...
% TODO -- size initialization to prevent need for resizing?
...
classdef PQ < handle
    ...
    methods (Access = public)       
        ...
        function obj = PQ( flagMaxPriorityQueue )
        ...
        function insert(obj, priority, value)     
            ...
            %disp(obj.numElements > 0) 
            %disp((obj.numElements + 1) > numel( obj.priorityList ))
